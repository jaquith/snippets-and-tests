  ...
  (function (id, loader) {
    ...
    u.send = function (a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        // (CUSTOM) the UNIQODO library stops on the first undefined values, so we need to fill it any gaps in the numbered keys with empty strings, up to the detected max
        ...
        if (u.data.order_id) {
          ...
          // (CUSTOM) - it's correct to simply fall back to an empty string here, as per
          // https://uniqodo.helpdocs.io/article/I77ERf5B2w-javascript-integration-guide-new
